...
namespace DinoFracture
{
    public class ChippedFractureRoot : MonoBehaviour
    {
        ...
        {
            FractureEngine.Instance.CancelCoroutine(_scanSeparatedChunksCoroutine);
        ...
        internal void StartScanForSeparatedChunks()
        {
            if (DetectDetachedChunks)
            {
                ...
                _scanSeparatedChunksCoroutine = FractureEngine.Instance.QueueCoroutine(ScanForSeparatedChunks());
            }
        }
